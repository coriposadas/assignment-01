/*
 * Taken from Practice Assignment code but modified for Assignment 1.
 */

public class SortingFactory {

	public final String defaultAlgorithm = "RunSort";  // If an improper algorithm name is given, which should be used?
	 ...
	 * @param algoName Sorting algorithm name; one of: run or merge.
	...
	public SortingAlgorithm getSortingAlgorithm(String algoName) throws Exception{
		...
		else if (lowercaseAlgoName.contains("run")) {
			return new RunSort();
		}
